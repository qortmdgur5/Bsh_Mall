...
<script src="https://t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script>  <!-- 다음 주소록 api 사용을 위한 스크립트추가 -->
<script>
...
/* 비밀번호 확인 일치 유효성 검사 */
	$('.pwck_input').on("propertychange change keyup paste input", function(){
	    ...
	    if(pw == pwck){		//비밀번호와 비밀번호 확인이 일치할때
	        $('.pwck_input_re_1').css('display','block');
	        $('.pwck_input_re_2').css('display','none');
	        pwckcorCheck = true;
	    }else{				//비밀번호와 비밀번호 확인이 일치하지않을때
